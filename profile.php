            ...
            <div>
                ...
                <form method="post" action="actions/updateprofile.action.php"class="row g-3 p-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" placeholder="saurav" name="full_name" value="<?=@$user['full_name']?>" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" placeholder="saurav@abc.com" name="email_id" value="<?=@$user['email_id']?>" class="form-control" required>
                    </div>
                    <div class="col-12">
