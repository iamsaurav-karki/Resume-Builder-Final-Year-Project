    ...
    <div class="container">
        ...
        <input type="hidden" name="slug" value="<?=$resume['slug']?>" />
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" value="<?=$resume['dob']?>" name="dob" id="dob" required>
      ...
      <div class="modal-body">
        <form method="post" action="actions/addexperience.action.php" class="row g-3" onsubmit="return validateForm()">
          ...
          <div class="col-md-6">
            ...
            <div id="started-error" class="text-danger" style="display: none;"></div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div id="endDate-error" class="text-danger" style="display: none;"></div>
          </div>
      ...
      <div class="modal-body">
        <form method="post" action="actions/addeducation.action.php" class="row g-3" onsubmit="return validateEducationForm()">
          ...
          <div class="col-md-6">
            ...
            <div id="edu_started-error" class="text-danger" style="display: none;"></div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div id="edu_ended-error" class="text-danger" style="display: none;"></div>
          </div>
...
<!-- Add this error div below your Date of Birth input -->
